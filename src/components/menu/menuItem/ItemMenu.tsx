...
interface MenuItemProps {
  category: Category;
  item: MenuItem;
  handleUpdateMenuItem: (category: Category, item: MenuItem) => void; // TODO: understand why 'item' is defined but never used
  ...
  <li key={item.id} className="flex justify-between mb-3">
    ...
    <div className="flex gap-4">
      ...
      <button
        ...
        onClick={() => handleUpdateMenuItem(category, item)}
      >
        <svg
